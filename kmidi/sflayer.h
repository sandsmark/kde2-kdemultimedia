/*================================================================
 *	$Id: sflayer.h 33492 1999-11-11 04:16:06Z greglee $
 * sflayer.h
...
enum {
	SF_startAddrs,         /*  0 sample start address -4 (0 to * 0xffffff) */
        SF_endAddrs,	       /*  1 */
        ...
        SF_env2ToVolume,       /* 14 unused1 : ?? Env2Depth: env2-> volume */
        SF_chorusEffectsSend,  /* 15 chorus */
        SF_reverbEffectsSend,  /* 16 reverb */
        SF_panEffectsSend,     /* 17 pan */
        SF_auxEffectsSend,     /* 18 unused2 : ?? pan auxdata (internal) */
        SF_sampleVolume,       /* 19 unused3 : ?? used internally */
        SF_unused3,	       /* 20 */
